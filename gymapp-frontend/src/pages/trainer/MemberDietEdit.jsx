...
const MemberDietEdit = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await api.put(`/diet-logs/${dietId}`, formDataToSend, {
        headers: {
      ...
      navigate(`/trainer/members/${memberId}/diet/${dietId}`);
    } catch (error) {
      alert('수정에 실패했습니다.');
      console.error(error);
    } finally {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white shadow-sm sticky top-0 z-10">
        <div className="max-w-lg mx-auto px-4 py-4 flex items-center">
          <button onClick={() => navigate(`/trainer/members/${memberId}/diet/${dietId}`)} className="text-2xl mr-3">←</button>
          <div>
            <h1 className="text-xl font-bold">식단 기록 수정</h1>
